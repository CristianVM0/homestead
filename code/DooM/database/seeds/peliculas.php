...
class peliculas extends Seeder
{
    ...
    private function seedCatalog() {
        ...
        foreach( $this->arrayPeliculas as $peliculas ) {
            $p = new Pelicula;
            $p->title = $peliculas['title'];
            $p->year = $peliculas['year'];
            $p->director = $peliculas['director'];
            $p->poster = $peliculas['poster'];
            $p->rented = $peliculas['rented'];
            $p->synopsis = $peliculas['synopsis'];
            $p->save();
        }
    }
